...
use App\Http\Controllers\Admin\OrderOfServiceController;
use App\Http\Controllers\Admin\RsvpController as AdminRsvpController;
use App\Http\Controllers\Admin\WeddingPartyController as AdminWeddingPartyController;
...
Route::middleware(['auth', 'verified', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/guest-list', [AdminGuestGroupController::class, 'guestList'])->name('admin.guest-groups.guest-list');
    ...
    Route::get('/wedding-party', [AdminWeddingPartyController::class, 'index'])->name('admin.wedding-party.index');
    Route::post('/wedding-party', [AdminWeddingPartyController::class, 'store'])->name('admin.wedding-party.store');
    Route::patch('/wedding-party/page', [AdminWeddingPartyController::class, 'savePage'])->name('admin.wedding-party.page');
    Route::patch('/wedding-party/{weddingPartyMember}', [AdminWeddingPartyController::class, 'update'])->name('admin.wedding-party.update');
    Route::get('/wedding-party/{weddingPartyMember}/delete', [AdminWeddingPartyController::class, 'confirmDelete'])->name('admin.wedding-party.confirm-delete');
    Route::delete('/wedding-party/{weddingPartyMember}', [AdminWeddingPartyController::class, 'destroy'])->name('admin.wedding-party.destroy');
    Route::get('/order-of-service', [OrderOfServiceController::class, 'index'])->name('admin.order-of-service.index');
    Route::post('/order-of-service', [OrderOfServiceController::class, 'store'])->name('admin.order-of-service.store');
    Route::patch('/order-of-service/homepage', [OrderOfServiceController::class, 'saveHomepage'])->name('admin.order-of-service.homepage');
    Route::patch('/order-of-service/settings', [OrderOfServiceController::class, 'saveSettings'])->name('admin.order-of-service.settings');
    Route::get('/order-of-service/{orderOfServiceItem}/delete', [OrderOfServiceController::class, 'confirmDelete'])->name('admin.order-of-service.confirm-delete');
    Route::delete('/order-of-service/{orderOfServiceItem}', [OrderOfServiceController::class, 'destroy'])->name('admin.order-of-service.destroy');
    Route::match(['put', 'patch'], '/order-of-service/{orderOfServiceItem}', [OrderOfServiceController::class, 'update'])->name('admin.order-of-service.update');
